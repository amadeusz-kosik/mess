...
def print_usage():
    print("Creates a snapshot of given VM and ends service mode.")
    print("Parameters:")
    print("-m --vm-name MW1                            REQUIRED    name of worker VM")
    print("-a --snapshot-name snapshot name            REQUIRED    name of snapshot to create (if not default one)")
    print()
...
def main(argv):
    ...
    mess.close_service_mode(vm_name, snapshot_name)
